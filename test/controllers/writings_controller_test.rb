...
class WritingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create writing" do
    assert_difference('Writing.count') do
      post writings_url, params: { writing: { correct: @writing.correct, explanation: @writing.explanation, hint: @writing.hint, question: @writing.question } }
    end
  ...
  test "should update writing" do
    patch writing_url(@writing), params: { writing: { correct: @writing.correct, explanation: @writing.explanation, hint: @writing.hint, question: @writing.question } }
